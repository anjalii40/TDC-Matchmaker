...
const getApiUrl = (path)=>{
    const isProd = ("TURBOPACK compile-time value", "object") !== 'undefined' && window.location.hostname !== 'localhost';
    const apiBase = isProd ? 'https://tdc-matchmaker-1-mkrj.onrender.com' : '';
    return `${apiBase}${path}`;
};
...
function useCustomers() {
    ...
    const [viewMode, setViewMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('grid'); // 'list', 'grid' or 'kanban'
        ...
        "useCustomers.useEffect": ()=>{
            const fetchCustomers = {
                "useCustomers.useEffect.fetchCustomers": async ()=>{
                    try {
                        const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApiUrl"])('/api/customers'));
                        if (res.ok) {
...
_s(useCustomers, "5cVQow6HF7E6nayyEgAtq+y2mkg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_0-0nr92._.js.map